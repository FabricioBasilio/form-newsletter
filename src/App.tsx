...
function App() {
  return (
    <main className="bg-slate-900 min-h-screen w-full flex flex-col items-center justify-center">
      ...
      <section className="w-95 mt-4 bg-stone-200 px-4 py-5 rounded-lg">
        <Form />
      </section>
